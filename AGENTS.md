...
- Latest 2026-09-26 instruction: once the code-validation gate is met, synchronize aurora directly without another approval request or dedicated synchronization notification. This does not authorize merging unfinished lifecycle changes or publishing a Release.
