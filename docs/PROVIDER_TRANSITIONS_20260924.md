...
These sets are accessed only under transition admission. They track attempted initialization, not readiness, COM ownership, reference counts or handle generations. Repeated Init behavior remains forwarded. Combo child-level partial success still requires its own bookkeeping.
